...
/**
 * Restores a ATalk config.js from {@code localStorage} if it was
 ...
 * @returns {?Object} The ATalk config.js which was previously downloaded
...
export function setConfigFromURLParams(
    ...
    //     "interfaceConfig.APP_NAME": "ATalk"
    // }
    // We want to have:
    // json = {
    //     config: {

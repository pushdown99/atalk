...
/**
 * Signals that the configuration (commonly known in ATalk as config.js)
...
/**
 * Signals that a configuration (commonly known in ATalk as config.js)
...
/**
 * Stores a specific ATalk config.js object into {@code localStorage}.
 *
 * @param {string} baseURL - The base URL from which the config.js was
 * downloaded.
 * @param {Object} config - The ATalk config.js to store.
 * @returns {Function}
 */

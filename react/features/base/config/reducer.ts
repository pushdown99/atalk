 ...
 * JitsiMeetJS#init(). The app will download config.js from the ATalk
 ...
 * The app will download config.js from the ATalk deployment and take its
 ...
 * config.js from the ATalk deployment and take its values into account but
...
function _setConfig(state: IConfig, { config }: { config: IConfig; }) {
    ...
    const newState = _.merge(
        ...
        // downloaded from the ATalk deployment because the former contains

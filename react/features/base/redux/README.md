ATalk - redux state persistence
====================================
ATalk has a persistence layer that persists specific subtrees of the redux
...
When it's done, ATalk will automatically persist these subtrees and
